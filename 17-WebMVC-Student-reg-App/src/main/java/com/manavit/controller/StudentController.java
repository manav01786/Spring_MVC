...
import com.manavit.binding.Student;
import com.manavit.entity.StudentEntity;
import com.manavit.repo.StudentRepository;
...
public class StudentController {
	...
	// method to load student form (select line go rightclick refactor and go Extrc method)
